...
public class results_list_adapter extends RecyclerView.Adapter<results_list_adapter.MyViewHolder>
{
    Context c;
    String item_exams[];
    String item_date[];
    ...
    public results_list_adapter(Context ct, String date[], String results[], String ex_cd[]) {
        c=ct;
        item_exams=results;
        item_date=date;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=inflater.inflate(R.layout.rv_results_list,parent,false);
        ...
        holder.bt_timetable.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Student_Details.student_selected_exams_or_results=2;

                        c.startActivity(student_drawer_panel.intent);

                       // NavController navController= Navigation.findNavController(holder.itemView);

                      //  navController.navigate(R.id.action_student_exams_results_tablayout_to_student_resluts_byexams);
