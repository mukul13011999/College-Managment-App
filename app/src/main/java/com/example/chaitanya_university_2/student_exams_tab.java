 ...
 */
public class student_exams_tab extends Fragment {

    RecyclerView rv_exams_results;

    String []exams_g=new String[10];
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_student_exams_tab, container, false);
    }
    ...
    public void load_recyclerview()
    {
        ...
        exams_adapter adapter=new exams_adapter(getContext(),date_of_post_l,exams_l,exam_code_l);
    ...
    public void load_exams()
    {
       ...
       // progressDialog.show();
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST,"https://dorian-works.000webhostapp.com/get_exams_DEPTCODE_Y.php",
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            while(count<jsonArray.length())
                            {
                                ...
                                exams_g[count]=JO.getString("exam_name");
                ...
                } )
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("table_name","exams_"+Student_Details.student_dept_code+"_"+Student_Details.student_year+"_"+Student_Details.student_section);
